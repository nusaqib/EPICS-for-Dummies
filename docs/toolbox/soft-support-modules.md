...
| Documentation | [autoSaveRestore.md](https://github.com/epics-modules/autosave/blob/master/docs/autoSaveRestore.md) |
...
| **sseq** | Sequenced string/value output; scriptable action sequences as records | [github.com/epics-modules/sseq](https://github.com/epics-modules/sseq) |
...
| **snmp** | SNMP client support — network gear, PDUs, UPSs | [github.com/epics-modules/snmp](https://github.com/epics-modules/snmp) |
| **ipmiComm** | IPMI monitoring of MTCA/ATCA crates | [github.com/epics-modules/ipmiComm](https://github.com/epics-modules/ipmiComm) |
