...
**Sixteen thousand IOC-health PVs justify their own tooling.** 210 IOCs × ~60 [iocStats](../toolbox/soft-support-modules.md#iocstats-and-deviocstats) PVs is not noise — it's the data behind [the control-system health dashboard](../toolbox/observability.md), and it gets its own branch in the [alarm tree](alarm-plan.md).
